...
- [v2.0.1 release notes](RELEASE_NOTES_v2.0.1.md) documenting the GitHub-rendering compatibility patch; the completed behavior evidence remains the v2.0.0 result set.
